...
import 'package:greencollections/src/pages/agregar_recoleccion_page.dart';

import 'dart:math';
import 'dart:ui';

import 'package:greencollections/src/pages/recoleccion_diaria_page.dart';
import 'package:greencollections/src/pages/reportar_incidencia.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Widget _titulos() {
   ...
   Widget callTabs(int paginaActual){
      ...
      switch(paginaActual){
        case 0: return AgregarRecoleccionPage();
        case 1: return RecoleccionDiariaPage();
        case 2: return ReportarIncidenciaPage();
        default: return AgregarRecoleccionPage();
